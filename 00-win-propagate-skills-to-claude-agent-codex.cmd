...
pause
for %%S in (kit lit pix dac dac-help cop wiz vet fix val act umm mem map tut dora) do (
...
pause
for %%S in (nix kit lit pix dac dac-help cop wiz vet fix val act umm mem map tut gap pro dora) do (
