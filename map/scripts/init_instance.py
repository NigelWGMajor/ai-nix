...
<!-- Link format: Name | [path:line](path#Lline) | Layer -->
...
<!-- Example:
### Controller Layer
- ComponentName | [path/to/file.cs:42](path/to/file.cs#L42) | Controller
  - ChildComponent | [path/to/child.cs:15](path/to/child.cs#L15) | Service
-->
"""
