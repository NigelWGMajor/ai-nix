...
The source branch stays unchanged. Child PRs target the new reconstructed parent, and one final parent PR targets the original PR base. /pro never assumes that base is main.
